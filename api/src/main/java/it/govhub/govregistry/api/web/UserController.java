...
public class UserController implements UserApi {
	...
	public ResponseEntity<User> readUser(Long id) {
		...
		this.authService.expectAnyRole(GovregistryRoles.RUOLO_GOVHUB_SYSADMIN, GovregistryRoles.RUOLO_GOVHUB_USERS_EDITOR, GovregistryRoles.RUOLO_GOVHUB_USERS_VIEWER);
	...
	public ResponseEntity<User> updateUser(Long id, List<PatchOp> patchOp) {
		...
		this.authService.expectAnyRole(GovregistryRoles.RUOLO_GOVHUB_SYSADMIN, GovregistryRoles.RUOLO_GOVHUB_USERS_EDITOR);
